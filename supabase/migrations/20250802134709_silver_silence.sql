/*
  ...
  1. Admin User Creation
    - Creates admin user with email: admin@elverraglobal.com
    - Password: Admin123!
    - Sets up admin role assignment
...
-- Create admin user (this will be done manually through Supabase Auth)
-- Email: admin@elverraglobal.com
-- Password: Admin123!

-- Note: After creating the admin user manually in Supabase Auth dashboard,
-- run this to assign admin role:
-- SELECT public.assign_admin_role('admin@elverraglobal.com');